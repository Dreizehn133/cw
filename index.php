...
<body>
    <?php 
        define('X',"YXlhbSBnb3Jlbmc=");
        define('Y',"NG40SyA0TDR5");
        
        session_start();
        if(!isset($_SESSION['login'])|| $_SESSION['login']!="masuk"){ ?>
            <form action="index.php" method="POST">
                <label> USERNAME </label><input type="text" name="usern" >
